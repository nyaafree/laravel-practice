...
Route::prefix('users')->name('users.')->group(function () {
    // これはusers.showという名前がルーティングにつけられる
    ...
    // ここでは、groupメソッドを使用しています。
    // groupメソッドを使うことで、middleware('auth')が、groupメソッドにクロージャ(無名関数)として渡した各ルーティングにまとめて適用されます。
    // https://readouble.com/laravel/6.x/ja/routing.html#route-groups
